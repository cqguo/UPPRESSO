...
We propose the following identity transformations on an elliptic curve $\mathbb{E}$ of order $n$.
...
Here, $G$ is a base point on $\mathbb{E}$, and $[r]G$ denotes the addition of $G$ on the curve $r$ times.
