...
Then, an account is \emph{meaningful} at an RP if it belongs to some \emph{registered} user at this RP,
while a \emph{meaningless} account $A_m$ at $RP_j$ does not belong to any user, i.e., $\forall ID_{U_i}: A_m \neq \mathcal{F}_{Acct\ast}(ID_{U_i}, ID_{RP_j})$.
