...
Thus, (\emph{a}) IdP untraceability is proved in Section \ref{subsec:IdP-privacy} against \emph{an honest-but-curious IdP}, which tries to infer the identities of the \emph{honest} RPs being visited by an \emph{honest} user,
