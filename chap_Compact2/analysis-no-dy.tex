...
We propose the following ``silient'' account synchronization
     leveraging \emph{conditional} $PID_{RP}$ checking as below,
...
So the derived account must be meaningful when $PID_{RP}$ is equal to $[t]ID_{RP}$.
