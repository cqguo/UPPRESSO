...
${\ddag}$ \textbf{Accounts Derived from User-maintained Secret}: $\CIRCLE$ no, $\Circle$ required.
...
\item[3.]
UP-SSO \cite{up-sso} runs an Intel SGX enclave on the user side with a secret to calculate PPIDs.
