...
\item We designed the UPPRESSO protocol by integrating the identity transformations into OIDC, and proved that it satisfies the security and privacy requirements of SSO services.
