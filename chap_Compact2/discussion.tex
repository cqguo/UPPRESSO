...
In this case,
    a browser extension or plug-in is required
            to handle such a user secret,
             and privacy-preserving identity federation \cite{ELPASSO, UnlimitID, idemix, PseudoID, uprov} prefer this strategy.
...
Our strategy offers an options for different users.
