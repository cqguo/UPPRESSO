...
In this case, in Step 1.2 the user-r script sends only the endpoint but not its RP certificate, and the user-i script calculates $ID_{RP}$ by itself based on the RP's unambiguous name. 
