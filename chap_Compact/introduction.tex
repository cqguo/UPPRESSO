...
\usso\ prevents %two privacy risks,
 both IdP-based login tracing and RP-based identity linkage, while existing privacy-preserving SSO systems address only one of them \cite{BrowserID, SPRESSO, NIST2017draft, FirefoxAccount,save-flow} or an extra trusted server is needed \cite{miso}.
