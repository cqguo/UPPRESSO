...
\usso\ supports commercial-off-the-shelf (COTS) browsers without extensions or plug-ins to work as the user agent,
...
\begin{figure*}[htb]
  \centering
  \includegraphics[height=0.421\textheight]{fig/process-js.pdf}
