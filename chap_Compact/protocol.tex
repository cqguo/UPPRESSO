...
Thus, an \emph{unmatched} token results in a meaningless account which corresponds to an unregistered (or non-existing) user, and the RP will treat it as a newly-registered user.
We also discuss the impact of leaked user identities in Section \ref{sec:discussion}.
