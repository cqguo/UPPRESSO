...
In contrast, \usso\ incurs extra overheads in opening a new browser window and downloading scripts. This download overhead may be reduced %by silently conducting these operations when the user visits the RP website, or
