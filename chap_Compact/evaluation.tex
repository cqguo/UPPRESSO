  ...
  \centering
	\subfigure[In a virtual private cloud]{
  		\begin{minipage}[b]{0.44\textwidth}
			\includegraphics[width=0.9\linewidth]{fig/evaluation-lan.pdf}
		\end{minipage}}
	\subfigure[With a remotely-visiting browser]{
  		\begin{minipage}[b]{0.44\textwidth}
			\includegraphics[width=0.9\linewidth]{fig/evaluation-internet.pdf}
		\end{minipage}}
...
In contrast, \usso\ incurs extra overheads in opening a new browser window and downloading the scripts.\footnote{This download overhead can be reduced %by silently conducting these operations when the user visits the RP website, or
