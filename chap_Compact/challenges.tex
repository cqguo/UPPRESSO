...
An honest RP checks the RP's identity in the identity token before accepting it and authorizes the token holder to log in as the specified user. This prevents malicious RPs from replaying any received tokens to gain unauthorized access to other honest RPs as victim users.
