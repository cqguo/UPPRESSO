...
The relationships among the permanent and ephemeral (pseudo-)identities are depicted in Figure \ref{fig:IDCorrelation}, where the labeled arrows denote the transformations of (pseudo-)identities, and the \emph{red} and \emph{green} blocks represent \emph{permanent} and \emph{ephemeral} ones, respectively.
