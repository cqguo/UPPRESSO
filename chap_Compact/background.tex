...
3. Different from \cite{ELPASSO,UnlimitID}, a credential in U-Prove \cite{uprov} may contain some attributes \emph{invisible} to the IdP, in addition to the ones confirmed by the IdP.
