...
This paper presents a privacy-preserving SSO protocol, called \usso, to protect a user's online profile against (\emph{a}) an honest-but-curious IdP and (\emph{b}) malicious RPs and users who could collude.
...
This approach protects the unique identities of the user and the RPs that she requests to log into while working compatibly with widely-deployed SSO services and satisfying all the security requirements.
