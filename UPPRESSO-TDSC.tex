...
\author{Chengqian Guo, Jingqiang Lin, Quanwei Cai, Wentian Zhu, Wei Wang, Jiwu Jing, Qiongxiao Wang, Bin Zhao, and Fengjun Li
        % <-this % stops a space
\thanks{Chengqian Guo is affiliated with Yuncheng University, China. Jingqiang Lin (corresponding author, linjq@ustc.edu.cn), Wentian Zhu, and Wei Wang are affiliated with University of Science and Technology of China (USTC). Quanwei Cai is with Beijing Zitiao Network Technology Co., Ltd, China. Jiwu Jing is with University of Chinese Academy of Sciences (UCAS). Qiongxiao Wang is with Beijing Certification Authority (BJCA) Co., Ltd, China. Bin Zhao is JD.com Silicon Valley R\&D Center, USA. Fengjun Li is with the University of Kansas, USA.}% <-this % stops a space
\thanks{Manuscript received December 30, 2025; revised xxxx 11, xxxx.}}
