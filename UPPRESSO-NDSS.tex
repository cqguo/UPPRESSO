...
An identity-transformation approach is proposed to generate untraceable ephemeral pseudo-identities for an RP and a user in a login, %(denoted as $PID_{RP}$ and $PID_U$, respectively)
...
We built the UPPRESSO prototype providing OIDC-compatible SSO services, accessed from a commercial-off-the-shelf browser without plug-ins or extensions.
